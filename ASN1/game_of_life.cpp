...
namespace GOL
{
    ...
    int game_of_life::CheckLivingNeighbors(int cell_index) // might need to be size_t
    {
    ...
    bool game_of_life::DetermineCellStateForNextGen(int living_neighbors, bool alive)
    {
    ...
    void game_of_life::SetCellState(bool alive, size_t cell_index, string &next_gen_game)
    {
        if (alive)
        {
    ...
    int game_of_life::GetLeftCol(int col)
    {
        return ((col - 1) + width_) % width_;
    }

    int game_of_life::GetRightCol(int col)
    {
        return (col + 1) % width_;
    }

    int game_of_life::GetUpperRow(int row)
    {
        return ((row - 1) + height_) % height_;
    }

    int game_of_life::GetLowerRow(int row)
    {
